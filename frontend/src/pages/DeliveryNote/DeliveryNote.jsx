...
const DeliveryNote = () => {
  ...
  // Da der Warenkorb geleert werden soll, wird die Logik hier übernommen
  const [lieferscheinItems, setLieferscheinItems] = useState([]);

  useEffect(() => {
    //  Bestellung aus dem Backend laden
    // Dummy-Daten zur Darstellung
  ...
  return (
    <div className="kassier-container">
      ...
      <div className="delivery-info">
        ...
        {/* Hier könnten weitere Kundeninformationen angezeigt werden */}
      </div>

...
-- Exportiere Datenbank-Struktur für green
CREATE DATABASE IF NOT EXISTS `green` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
USE `green`;

-- Exportiere Struktur von Tabelle green.t_deliverynote
...
-- Exportiere Daten aus Tabelle green.t_deliverynote: ~0 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle green.t_invoice: ~0 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle green.t_invoice_deliverynote: ~0 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle green.t_majorcustomer: ~0 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle green.t_order: ~0 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle green.t_product_order: ~0 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle green.t_unit: ~0 rows (ungefähr)
